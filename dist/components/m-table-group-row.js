  ...
  (0, _createClass2["default"])(MTableGroupRow, [
    {
      ...
      value: function render() {
        ...
        var counter = this.props.groupData.data.length;
        var conterText = this.props.options.showGroupCount
          ? "(".concat(counter, ") ")
          : "";
        var groupText = "".concat(conterText).concat(title).concat(separator);
        return /*#__PURE__*/ React.createElement(
          React.Fragment,
          null,
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement("b", null, groupText)
            )
          ),
          detail
        );
